...
public class AclRepositoryImpl implements AclRepository {
    ...
    public void addPermission(AbstractSecuredEntity element, Sid recipient, Permission permission) {
        addPermission(element, recipient, permission, true);
    }

    @Override
    @Transactional
    public void addPermission(AbstractSecuredEntity element, Sid recipient, Permission permission, boolean granting) {
        MutableAcl acl;
    ...
    public boolean addAccessControlEntry(AbstractSecuredEntity element, Sid recipient, Permission permission) {
        return addAccessControlEntry(element, recipient, permission, true);
    }

    @Override
    @Transactional
    public boolean addAccessControlEntry(AbstractSecuredEntity element, Sid recipient, Permission permission, boolean granting) {
